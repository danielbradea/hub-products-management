package com.bid90.hpm.security;
...
@SecurityScheme(
        ...
        description = """
                ...
                Admin (username: admin, password: admin) has 'admin' role \n
                User (username: user, password: user) has 'user' role. \n
                """
)
@OpenAPIDefinition(servers = {@Server(url = "/", description = "Main server hosting the API.")})
